...
liste_nom_supp = [
    "Farine de viande (toutes)",
    "Féverole à fleurs blanches",
    "Gluten feed de blé, type 20% amidon",
    "Graine de lin",
    "Graine de soja extrudée",
    "Graine de tournesol",
    "Lupin générique",
    "Luzerne déshydratée, générique",
    "Maïs",
    "Manioc, amidon 70-74 %",
    "Orge",
    "Pois",
    "Pois chiche, type Kabuli",
    "Pulpe d'agrumes déshydratée",
    "Pulpe de betterave déshydratée",
    "Radicelles d'orge de brasserie déshydratées",
    "Remoulage de blé tendre (tous)",
    "Seigle",
    "Son de blé tendre",
    "Sorgho",
    "Tourteau d'arachide, huile < 5 %, cellulose brute > 9 %",
    "Tourteau de colza, huile < 5 %",
    "Tourteau de colza, huile 5-20 %",
    "Tourteau de coprah, huile 5-20%",
    "Tourteau de germes de maïs, huile < 5 %",
    "Tourteau de germes de maïs, huile 5-20 %",
    "Tourteau de lin, huile > 5 %",
    "Tourteau de palmiste, huile 5-20%",
    "Tourteau de soja, huile < 5 %, 48 % protéine + huile",
    "Tourteau de soja, huile < 5 %, 50 % protéine + huile",
    "Tourteau de tournesol, huile < 5 %, décortiqué",
    "Tourteau de tournesol, huile < 5 %, non décortiqué",
    "Triticale",
    "Riz",
    "Drêches de maïs de distillerie avec solubles, déshydratées, huile < 6 %, protéines < 30 %",
    "Drêches de maïs de distillerie avec solubles, déshydratées, huile > 6 %",
    "Farine fourragère de maïs",
    "Germes de maïs",
    "Son de maïs",
    "Coques de sarrasin",
    "Drêches d'orge de brasserie déshydratées",
    "Farine basse de riz",
    "Son de riz, huile < 5 %",
    "Son de riz, huile > 5 %",
    "Graine de colza",
    "Graine de coton",
    "Grignon d'olive",
    "Tourteau de coton, huile < 5 %",
    "Tourteau de coton, huile 5-20 %",
    "Tourteau de tournesol, huile > 5 %",
    "Amidon de maïs",
    "Marc ou pulpe de raisin déshydraté",
    "Mélasse de canne ou de betterave",
    "Vinasse de levurerie",
    "Concentré protéique de soja",
    "Farine de gousse de caroube",
    "Levure de brasserie déshydratée",
    "Paille de blé",
    "Lactosérum écrèmé déshydraté (doux ou acide)",
    "Lactosérum réengraissé",
...
df_all_results.to_csv("../reports/results_leave_one_name_out.csv", index=False)
